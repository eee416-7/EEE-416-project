...
//************************************************************************
#define tempPin1 0 // 8 pin of the arduino as the 1st binary digit of temp sensor, sent to D3 of nodeMCU
#define tempPin2 2 // 9 pin of the arduino as the 2nd binary digit of temp sensor, sent to D4 of nodeMCU
//************************************************************************
//************************************************************************
//Fingerprint scanner Pins
#define Finger_Rx 14 //D5, connect sensor Tx here
#define Finger_Tx 12 //D6, connect sensor Rx here
...
const char *ssid = "Enma";  //ENTER YOUR WIFI SETTINGS
const char *password = "password";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.141.55/biometricattendance/getdata.php"; //computer IP or the server domain
...
void setup() {
  ...
  // The outputs from the thermal sensor defined as input
...
void loop() {
  ...
  // Get body temperature from the thermal sensor
  int D0 = 0;
  int D1 = 0;
  D0 = digitalRead(tempPin1);
  D1 = digitalRead(tempPin2);

  Serial.println("First Digital Bit:");
  Serial.println(D0);
  Serial.println(D1);

  // [D1, D0] is the two bit binary data indicating temperature reading cases.
  // 01 - good temperature, student healthy, 10 - high temperature, don't take fingerprint, 11 - temperature reading not yet taken

  if(D0 == 1 && D1 == 1){ // no temperature reading
    display.clearDisplay();
    display.setTextSize(2);
    display.setCursor(0,0);
    display.print("Please get your temperature reading!");
    display.display();
    flag = 1;
  }

  if(D0 == 0 && D1 == 1){ // high temperature
    flag = 1;
    display.clearDisplay();
    display.setTextSize(2);
    display.setCursor(0,0);
    display.print("Your temperature is too high!");
    display.display();
    delay(2000);
